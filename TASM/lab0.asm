...
.code
	_main:
		...
		fldcw cwr
		fld st(0)
		frndint				; st(0) - ����� ����� �� log2(exp^st(1))
		fsub st(1), st(0) 		; st(1) - ������������ ����� �� log2(exp^st(1))
		fld1
		fscale				; st(0) - 2^[����� ����� �� log2(exp^st(1))], st(1) - �����
		fstp st(1)			; st(0) - 2^[����� ����� �� log2(exp^st(1))], st(1) - ������������ ����� �� log2(exp^st(1))
		fxch st(1)			; st(0) - ������������ ����� �� log2(exp^st(1)), st(1) - 2^[����� ����� �� log2(exp^st(1))]
		f2xm1
		fld1
		fadd				; st(0) - 2^[������������ ����� �� log2(exp^st(1))], st(1) - 2^[����� ����� �� log2(exp^st(1))]
		fmulp st(1), st(0)
