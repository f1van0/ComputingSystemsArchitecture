...
mov ax, @data
mov ds,ax
mov colsEraser, colsAmount ;стиратель колонок должен знать сколько колонок будет заполнено
